...
export default function BlogPage() {
 ...
 <div>
 <h1 className="text-xl font-bold text-sand-800 lg:text-2xl">
 Health Tips
 </h1>
...
"shrink-0 rounded-full px-4 py-1.5 text-xs font-semibold transition-all",
 ...
 <h2 className="mt-3 text-lg font-bold leading-snug text-sand-800 lg:text-xl">
 {featured.title}
 </h2>
 ...
 className="flex gap-3.5 rounded-xl border border-sand-200 bg-white p-3 transition-shadow hover:shadow-md md:flex-col md:gap-2"
 >
 {/* Thumbnail */}
 <div className={cn(
"flex h-20 w-20 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br text-2xl md:h-32 md:w-full",
 ...
 <BookOpen className="h-6 w-6 text-sand-400" />
 </div>
