      ...
      <div className="mx-auto max-w-lg">
        ...
        <div className="mb-5">
          ...
          <select
            ...
            className="h-11 w-full rounded-lg border border-sand-200 dark:border-border bg-white dark:bg-background px-4 text-sm text-sand-800 dark:text-foreground outline-none focus:border-brand-400 focus:ring-2 focus:ring-brand-100 dark:focus:ring-brand-500/20 transition-colors"
          >
        ...
        <div className="mb-6">
          ...
          {documentUrl ? (
            <div className="flex items-center gap-3 rounded-xl border border-sand-200 dark:border-border bg-white dark:bg-card p-4">
              {documentType === "pdf" ? (
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-sand-700 dark:text-foreground truncate">
                  Insurance Document
                </p>
              ...
              <button
                ...
                className="flex h-8 w-8 items-center justify-center rounded-lg hover:bg-sand-100 dark:hover:bg-secondary text-sand-400 transition-colors"
              >
                <Trash2 className="h-4 w-4" />
              </button>
            </div>
          ) : (
            <label className="flex cursor-pointer flex-col items-center gap-3 rounded-xl border-2 border-dashed border-sand-300 dark:border-border p-8 text-center transition-colors hover:border-brand-400 hover:bg-brand-50/50 dark:hover:border-primary dark:hover:bg-brand-500/5">
              <Upload className="h-8 w-8 text-sand-400 dark:text-muted-foreground" />
              <div>
                <p className="text-sm font-medium text-sand-600 dark:text-muted-foreground">
                  Upload insurance document
                </p>
                <p className="mt-0.5 text-xs text-sand-400 dark:text-muted-foreground">
        ...
        {/* What's Covered */}
        <div className="mb-8">
          <h3 className="mb-3 text-sm font-semibold text-sand-700 dark:text-foreground">
            What&apos;s Covered
          </h3>
          <div className="flex flex-wrap gap-2">
            {insuranceCoveredCategoryIds.map((catId) => (
              <span
                key={catId}
                className="inline-flex items-center gap-1.5 rounded-full bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 px-3 py-1.5 text-xs font-medium text-emerald-700 dark:text-emerald-400"
              >
          ...
          <p className="mt-2 text-xs text-sand-400 dark:text-muted-foreground">
        ...
        {hasInsurance && (
          <button
            ...
            className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl border border-sand-200 dark:border-border px-4 py-3 text-sm font-medium text-deal transition-colors hover:bg-red-50 dark:hover:bg-destructive/10"
          >
            <Trash2 className="h-4 w-4" />
            Remove Insurance
          </button>
