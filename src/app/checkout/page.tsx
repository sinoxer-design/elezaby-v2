    ...
    >
      ...
      <div className="flex items-center gap-3">
        <button
          type="button"
          onClick={() => router.back()}
          className="flex h-9 w-9 items-center justify-center rounded-lg text-sand-500 dark:text-muted-foreground transition-colors hover:bg-sand-100 dark:hover:bg-muted hover:text-sand-700"
        >
      ...
      <section className="rounded-xl bg-white dark:bg-card p-4 shadow-card">
        ...
        <div className="mt-4 flex flex-col gap-3 max-w-lg mx-auto">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Input
              ...
              required
              className="h-11 rounded-xl bg-sand-50 dark:bg-muted px-4 text-sm"
            />
          </div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                <select
                  ...
                  required
                  className="h-11 w-full appearance-none rounded-xl border border-input bg-sand-50 dark:bg-muted px-4 pr-9 text-sm text-sand-800 dark:text-foreground transition-shadow outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px]"
                >
      ...
      <section className="rounded-xl bg-white dark:bg-card p-4 shadow-card">
        ...
        <div className="mt-3 flex flex-col gap-3">
          ...
          {paymentMethod === "card" && (
            <div className="flex flex-col gap-3 rounded-xl border border-sand-200 dark:border-border bg-sand-50 dark:bg-muted p-3">
              <div className="flex flex-col gap-1.5">
                <label
                  htmlFor="card-number"
                  className="text-sm font-medium text-sand-700"
                ...
                <Input
                  ...
                  maxLength={19}
                  className="h-11 rounded-xl bg-white dark:bg-card px-4 text-sm"
                />
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div className="flex flex-col gap-1.5">
