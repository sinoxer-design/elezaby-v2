        ...
        {offerOpen && (
          <>
            ...
            <motion.div
              ...
              transition={{ type: "spring", stiffness: 300, damping: 25 }}
              className="fixed bottom-24 start-4 z-50 w-72 overflow-hidden rounded-2xl bg-white dark:bg-card shadow-elevated"
            >
              {/* Gradient Header */}
              <div
                className={cn(
              ...
              <div className="p-4">
                ...
                <div className="mt-3 flex items-center gap-2">
                  <div className="flex-1 rounded-lg border-2 border-dashed border-sand-300 dark:border-border bg-sand-50 dark:bg-secondary px-3 py-2">
                    <span className="font-mono text-sm font-bold tracking-wider text-brand-700 dark:text-primary">
                ...
                {/* Expiry */}
                <div className="mt-3 flex items-center gap-1.5 text-xs text-sand-400 dark:text-muted-foreground">
