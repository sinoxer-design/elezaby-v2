...
export function ProfileCompletionAlert() {
 ...
 >
 <div className="relative overflow-hidden rounded-xl bg-white border border-sand-200 shadow-sm p-4">
 {/* Dismiss button */}
 <button
 onClick={handleDismiss}
 className="absolute end-3 top-3 flex h-6 w-6 items-center justify-center rounded-full bg-sand-200/50 text-sand-500 hover:bg-sand-200 transition-colors"
 aria-label="Dismiss"
 >
